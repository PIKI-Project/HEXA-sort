...
namespace HexaSort.UI
{
    public class LevelSelectScreen : MonoBehaviour
    {
        ...
        [Header("Colors")]
        [SerializeField] private Color unlockedColor = new Color(0.42f, 0.39f, 1f);
        [SerializeField] private Color lockedColor = new Color(0.29f, 0.29f, 0.29f);
        [SerializeField] private Color completedColor = new Color(0.31f, 0.80f, 0.64f);
